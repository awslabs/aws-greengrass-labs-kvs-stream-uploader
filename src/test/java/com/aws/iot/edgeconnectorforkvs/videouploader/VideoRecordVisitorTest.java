...
public class VideoRecordVisitorTest {
    ...
    public void listFilesToUpload_invalidFolder_emptyList() {
        ...
        List<File> videoFiles = videoRecordVisitor.listFilesToUpload(videoUploadingStartTime, videoUploadingEndTime);
    ...
    public void listFilesToUpload_validInputs_nonEmptyList() {
        ...
        // and now-300s
        List<File> videoFiles = videoRecordVisitor.listFilesToUpload(videoUploadingStartTime,
